...
tx_signal_values, _ = convert_dB_to_valid_hex_sivers_register_values(rx_bb_gain_1, 
                                                                                    rx_bb_gain_2, 
                                                                                    rx_bb_gain_3, 
                                                                                    rx_bfrf_gain, 
                                                                                    tx_bb_gain, 
...
myrfsoc_node_ip_addr = '10.1.1.30'
...
myrfsoc_node.start_thread_receive_meas_data()

myrfsoc_node.transmit_signal(carrier_freq=float(freq_op),
